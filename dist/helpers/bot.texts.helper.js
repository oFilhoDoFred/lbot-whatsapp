const botTexts = {
    ...
    new_user: "🍄 Boas vindas ao {$1}\n\n" +
        `👋 Olá {$2}, vi você chegando, queria dizer que você é muito bem vinde, faça sua apresentação e se precisar de algo, nossos ADMs estão a disposição. 
		Para abrir o menu de comandos digite *{$p}menu*`,
    ...
    group_welcome_message: "👋 Olá, @{$1} vi você chegando, queria dizer que você é muito bem vinde ao grupo {$2}.\n" +
		"Faça sua apresentação e se precisar de algo, nossos ADMs estão a disposição.\n\n" +
        "{$3}" +
        `Digite *{$p}menu* para ver os comandos que temos a disposição.`,

    welcome_second_message: '*Para te conhecermos melhor, que tal seguir este formato? (copie e cole respondendo)* 👇\n\n' +
        '👩🏽‍🦱 *Nome/Apelidos:*\n' +
        'R: \n\n' +
        '⚛️ *Idade e Signo:*\n' +
        'R: \n\n' +
        '🚀 *Em que região de SP mora?*\n' +
        'R: \n\n' +
        '🔭 *O que você faz da vida?* _(Trampo, estudos, hobbies)_\n' +
        'R: \n\n' +
        '🗣️ *Quais assuntos mais gosta?* _(cite ao menos 3)_\n' +
        'R: \n\n' +
        '🏳️‍🌈 *Como vai o coração, quem é você na bandeira e qual pronome usar?*\n' +
        'R: \n\n' +
        '🙊 *Fale algo mais sobre você!* _(opcional)_\n' +
        'R: \n\n' +
        '📷 _Que tal uma foto pra gente te reconhecer nos encontros? É opcional!_ 😉',
