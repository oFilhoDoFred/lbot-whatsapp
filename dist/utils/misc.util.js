// ARQUIVO: utils/misc.util.js (VERSÃO ATUALIZADA)
// (Todo o restante do arquivo permanece igual, a única mudança é na função wheatherInfo)
...
// ... (todas as outras funções como animeReleases, mangaReleases, etc. ficam aqui)
...
export async function wheatherInfo(location) {
    try {
        // AQUI ESTÁ A MUDANÇA: Pedimos 3 dias de previsão em vez de 1.
